...
{cart.map((prop) => (
       <div key={prop.id} className=" flex  justify-between  sm:items-center mx-1 sm:mx-5 shadow-md pb-2 px-3 lg:px-20 py-7 my-5">
       <Link to={prop.to} className=" flex justify-between sm:items-center  ">
         ...
         <div>
           <h6 className="mt-4 text-brown font-semibold">{prop.location}</h6>
