  ...
  const [showThree, setShowThree] = useState(false);
    ...
    return ( 
     ...
     <div className={showThree? `fixed inset-0  w-full bg-gray-800 bg-opacity-20 flex justify-center items-center` : `mr-1`} onClick={() => showThree ?  setShowThree(false) : setShowThree(true)}>
         <img src={displayImg} alt="heaven estate property" className={ showThree? `h-[300px] w-[300px] sm:h-[350px] sm:w-[350px] lg:h-[350px] lg:w-[400px]  mx-auto flex my-auto` : ` h-20 w-full rounded-lg mt-1 mr-1`} onClick={() => setShowThree(true)}/>
      </div>
